...
// === TẠM KHÓA ĐĂNG NHẬP ===
// Chặn mọi tài khoản login vào app. Mọi request đăng nhập trả lỗi bảo trì.
// Để mở lại: khôi phục phần code đã comment bên dưới và bỏ handler tạm này.
...
// --- Logic đăng nhập gốc (tạm vô hiệu hóa) ---
